...
class PostSeeder extends Seeder
{
    ...
    public function run(): void
    {
        Post::create([
            ...
            'body' => 'Isi materi lengkap HCI ada di sini. bla bla bla...',
            'published_at' => now()
        ]);
        ...
        Post::create([ 
            ...
            'body' => 'Isi materi lengkap User Experience. Ini mencakup persepsi, emosi, dan respons pengguna terhadap berbagai aspek sistem. UX yang baik sangat penting untuk kesuksesan produk digital karena menentukan seberapa mudah dan menyenangkan produk itu digunakan.', 
            'published_at' => now()
        ]);
        ...
        Post::create([ 
            ...
            'body' => 'Isi materi lengkap UX untuk Digital Immersive Technology. Pembahasan ini mencakup desain interaksi dalam ruang 3D, cara mengurangi motion sickness, dan bagaimana menciptakan rasa kehadiran (presence) yang meyakinkan bagi pengguna.', 
            'published_at' => now()
        ]);

        // Materi Software Engineering 
        Post::create([
            'category_id' => 2, 'writer_id' => 1, 'title' => 'Pattern Software Design', 'slug' => 'pattern-software-design',
            ...
            'body' => 'Isi materi lengkap Pattern Software Design. Mempelajari design pattern seperti Singleton, Factory, dan Observer membantu developer menulis kode yang lebih fleksibel, mudah dirawat, dan efisien untuk jangka panjang.', 
            'published_at' => now()
        ]);

        Post::create([ 
            'category_id' => 2, 'writer_id' => 1, 'title' => 'Agile Software Development', 'slug' => 'agile-software-development',
        ...
        Post::create([ 
            'category_id' => 2, 'writer_id' => 1, 'title' => 'Code Reengineering', 'slug' => 'code-reengineering',
            ...
            'body' => 'Isi materi lengkap Code Reengineering. Ini bukan tentang menambahkan fitur baru, tetapi tentang membersihkan kode lama (refactoring), memperbaiki bug tersembunyi, dan mengadaptasi kode agar sesuai dengan standar modern tanpa mengubah fungsionalitas eksternalnya. ', 
            'published_at' => now()
        ]);
    }
}